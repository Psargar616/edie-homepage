...
![screenshot](./screenshots/edie-webpage-solution.png)

Created the 'Edie Website Homepage' using HTML, CSS and JS. Added hamburger navigation menu and used properties such as css grids and media queries to add responsiveness to the webpage.
